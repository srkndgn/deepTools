#!/bin/bash
#SBATCH --job-name=deepTools_PMD_vs_CPGi
...
$BIGWIG/KO_1.spleen.bw \
$BIGWIG/KO_2.spleen.bw \
-R $BED/PMD_mm10_CpG_islands_sorted.bed \
$BED/HMD_mm10_CpG_islands_sorted.bed \
--binSize 100 \
--regionBodyLength 1000 \
-a 5000 -b 5000 \
--outFileName PMD_HMD_mm10_CPGi.gz \

plotProfile --matrixFile PMD_HMD_mm10_CPGi.gz \
    --perGroup \
    --yMin 0 \
    --yMax 100 \
    --plotHeight 12 \
    --plotWidth 17 \
    --outFileNameData 100_PMD_HMD_mm10_CPGi.tab \
    --outFileName 100_PMD_HMD_mm10_CPGi.pdf \
    --plotTitle "CpGi methylation around PMDs & HMDs (bin=100bp)" \
