...
#SBATCH --time=240:00:00 # hh:mm:ss
...
-R $BED/PMD_mm10_L1_sorted.bed \
$BED/HMD_mm10_L1_sorted.bed \
--binSize 100 \
--regionBodyLength 1000 \
-a 5000 -b 5000 \
--outFileName PMD_HMD_mm10_L1.gz \

plotProfile --matrixFile PMD_HMD_mm10_L1.gz \
    --perGroup \
    --yMin 0 \
    --yMax 100 \
    --plotHeight 12 \
    --plotWidth 17 \
    --outFileNameData 100_PMD_HMD_mm10_L1.tab \
    --outFileName 100_PMD_HMD_mm10_L1.pdf \
    --plotTitle "Methylation over mm10 L1 around PMDs & HMDs (bin=100bp)" \
