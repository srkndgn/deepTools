...
-R $BED/PMD_mm10_IAPEz_int_sorted.bed \
$BED/HMD_mm10_IAPEz_int_sorted.bed \
--binSize 100 \
--regionBodyLength 1000 \
-a 5000 -b 5000 \
--outFileName PMD_HMD_mm10_IAPEz_int.gz \

plotProfile --matrixFile PMD_HMD_mm10_IAPEz_int.gz \
    --perGroup \
    --yMin 0 \
    --yMax 100 \
    --plotHeight 12 \
    --plotWidth 17 \
    --outFileNameData 100_PMD_HMD_mm10_IAPEz_int.tab \
    --outFileName 100_PMD_HMD_mm10_IAPEz_int.pdf \
    --plotTitle "Methylation over mm10 IAPEz_int around PMDs & HMDs (bin=100bp)" \
