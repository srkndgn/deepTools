...
-R $BED/PMD_mm10_IAPs_sorted.bed \
$BED/HMD_mm10_IAPs_sorted.bed \
--binSize 100 \
--regionBodyLength 1000 \
-a 5000 -b 5000 \
--outFileName PMD_HMD_mm10_IAP.gz \

plotProfile --matrixFile PMD_HMD_mm10_IAP.gz \
    --perGroup \
    --yMin 0 \
    --yMax 100 \
    --plotHeight 12 \
    --plotWidth 17 \
    --outFileNameData 100_PMD_HMD_mm10_IAP.tab \
    --outFileName 100_PMD_HMD_mm10_IAP.pdf \
    --plotTitle "Methylation over mm10 IAPs around PMDs & HMDs (bin=100bp)" \
