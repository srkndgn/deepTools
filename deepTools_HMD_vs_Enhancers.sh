...
-R $BED/PMD_mm10_Enhancers_sorted.bed \
$BED/HMD_mm10_Enhancers_sorted.bed \
--binSize 100 \
--regionBodyLength 1000 \
-a 5000 -b 5000 \
--outFileName PMD_HMD_mm10_Enhancers.gz \

plotProfile --matrixFile PMD_HMD_mm10_Enhancers.gz \
    --perGroup \
    --yMin 0 \
    --yMax 100 \
    --plotHeight 12 \
    --plotWidth 17 \
    --outFileNameData 100_PMD_HMD_mm10_Enhancers.tab \
    --outFileName 100_PMD_HMD_mm10_Enhancers.pdf \
    --plotTitle "Methylation over mm10 Enhancers around PMDs & HMDs (bin=100bp)" \
